...
public class TestUtils {
    ...
    public static SampleIntermediate sample(String id, Priority priority, String analysisType, int analysisTime, String arrivalTime) {
    ...
    public static TechnicianIntermediate technician(String id, List<SpecialityIntermediate> specialities, double efficiency, String start, String end) {
    ...
    public static EquipmentIntermediate equipment(String id, SpecialityIntermediate speciality, List<String> compatibleTypes, int cleaningTime) {
    ...
    public static LabInputIntermediate input(List<SampleIntermediate> samples,
